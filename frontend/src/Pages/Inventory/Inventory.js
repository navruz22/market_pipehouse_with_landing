...
function Inventory() {
    ...
    const headers = [
        { styles: 'w-[10%]', title: '№' },
        { styles: 'w-[10%]', title: t('Kategoriyasi') },
        { styles: 'w-[10%]',  title: t('Kodi') },
        { styles: 'w-[20%]',  title: t('Nomi') },
        { styles: 'w-[10%] text-center', title: t('Dastlabki') },
        { styles: 'w-[10%] text-center', title: t('Sanoq') },
        { styles: 'w-[10%] text-center', title: t('Farq') },
        { styles: '',  title: t('Izoh') },
        { styles: '',  title: ' ' }
    ]
